---
title: "**OreSat Star Tracker Camera Board**"
subtitle: |
...
taking a picture of stars and comparing it to a star catalog. This is the small daughterboard that holds the
image sensor and connects to the star tracker card via a flat-flexible cable (FFC).
...
- 4 layer board
- Bounding box is 31.5 x 13.3 mm
...
- This PCBA is all surface mount (SMT) components.
