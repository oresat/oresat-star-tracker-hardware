...
class match_result(_object):
    ...
    __swig_setmethods__["dec"] = _beast.match_result_dec_set
    __swig_getmethods__["dec"] = _beast.match_result_dec_get
    if _newclass:
        dec = _swig_property(_beast.match_result_dec_get, _beast.match_result_dec_set)
    __swig_setmethods__["ra"] = _beast.match_result_ra_set
    __swig_getmethods__["ra"] = _beast.match_result_ra_get
    if _newclass:
        ra = _swig_property(_beast.match_result_ra_get, _beast.match_result_ra_set)
    __swig_setmethods__["ori"] = _beast.match_result_ori_set
    __swig_getmethods__["ori"] = _beast.match_result_ori_get
    if _newclass:
        ori = _swig_property(_beast.match_result_ori_get, _beast.match_result_ori_set)
