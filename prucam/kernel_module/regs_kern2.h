...
camReg startupRegs[] = {
  ...
  */
  ...
  {.reg = 0x3046, .val = 0x0100}, //flash: enable flash signal, helps verify exposure

  //===CONTEXT B STUFF, DONT THINK I NEED THIS NOW
  /*
     {.reg = 0x308C, .val = 0x0000}, //y_addr_start_cb
     {.reg = 0x308A, .val = 0x0000}, //x_addr_start_cb
     {.reg = 0x3090, .val = 0x03BF}, //y_addr_end_cd
     {.reg = 0x308E, .val = 0x04FF}, //x_addr_end_cb
     {.reg = 0x30AA, .val = 0x03DE}, //frame_length_lines_cb
     {.reg = 0x3016, .val = 0x0064}, //course_integration_time_cb
     {.reg = 0x3018, .val = 0x00C0}, //fine_integration_time_cb
     {.reg = 0x30A8, .val = 0x0001}, //y_odd_inc_cb
  //==============================================
  */
  ...
  //GAIN: TODO not sure these make sense for mono, try defaults
  /*
     {.reg = 0x3056, .val = 0x0030}, //green1_gain: 1.5 green gain
     {.reg = 0x3058, .val = 0x0042}, //blue_gain: 2.0625 blue gain
     {.reg = 0x305A, .val = 0x0042}, //reg_gain: 2.0625 reg gain
     {.reg = 0x305C, .val = 0x0030}, //green2_gain: 1.5 green gain
     */
